# OCR GCSE Computer Science (J277) – Specification Contents

> Use this page as your master checklist. Tick off topics as you revise them.  
> All links go to the relevant topic file.
...
- [ ] [1.1 Systems architecture](computer-systems/1.1-systems-architecture.md)
  ...
  - [ ] CPU performance factors (clock speed, cache size, number of cores)
  - [ ] Embedded systems
...
- [ ] [1.2 Memory and storage](computer-systems/1.2-memory-and-storage.md)
  ...
  - [ ] Units of data storage (bit, nibble, byte, KB, MB, GB, TB, PB)
  - [ ] Data representation: binary, denary, hexadecimal
  - [ ] Binary arithmetic and overflow
  - [ ] Character encoding (ASCII, Unicode)
  - [ ] Representing images (pixels, colour depth, resolution, file size)
...
- [ ] [2.3 Producing robust programs](algorithms-programming/2.3-producing-robust-programs.md)
  ...
  - [ ] Input validation
  - [ ] Authentication
  - [ ] Testing (types of testing, test data)
